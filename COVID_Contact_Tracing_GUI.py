    ...
    def search_entry(self):
        ...
        if entries:
            ...
            for entry in entries:
                ...
                message += f"Email Address: {entry[4]}\n"
                message += f"Address: {entry[5]}\n"
                message += f"Contact Person Name: {entry[6]}\n"
                message += f"Contact Person Phone Number: {entry[7]}\n"
                message += f"Contact Person Email Address: {entry[8]}\n"
                message += f"Relationship to the contact person: {entry[9]}\n"
                message += f"Date today: {entry[10]}\n"
                message += f"Time right now: {entry[11]}\n"
